  ...
  return (
    <div style={{ userSelect: "none" }}>
      ...
      <DemoBlock title="多种填充模式">
        <DemoBlock title="Multiple fill modes"></DemoBlock>
        <Space wrap>
      ...
      <DemoBlock title="Custom rounded corners">
        <Space wrap>
          <Image
            src={demoSrc}
            width={64}
      ...
      <DemoBlock title="Uniformly set image sizes via CSS variables">
      ...
      <DemoBlock title="Loading failed">
        <Image src="/404" width={100} height={100} />
      </DemoBlock>

      {/* <DemoBlock title='懒加载'> */}
      <DemoBlock title="Slow Loading">
